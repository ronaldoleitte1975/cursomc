...
import com.ronaldo.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Categoria cat6 = new Categoria(null, "Decoracão");
		...
		produtoRepository.saveAll(Arrays.asList(p1, p2, p3, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11));
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "roclei31@yahoo.com.br", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("23763323", "93838393"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 300", "Centro", "3877012", cli1, c2);
