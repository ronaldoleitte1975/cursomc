package com.ronaldo.cursomc.resources.exceptions;
...
import com.ronaldo.cursomc.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request) {
		...
		ValidationError err = new ValidationError(HttpStatus.BAD_REQUEST.value(), "Erro de Validacão",
				System.currentTimeMillis());
